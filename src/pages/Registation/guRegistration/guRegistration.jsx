...
const GuRegistration = () => {
  ...
  useEffect(() => {
    axios.get('http://31.172.83.7:3000/getStaffStatus')
      .then((response) => {
    ...
    axios.get('http://31.172.83.7:3000/getVehcleStatus')
      .then((response) => {
  ...
  const handleDelete = (e) => {
    ...
    if (garison.length > 0) {
      ...
      axios.delete('http://31.172.83.7:3000/deleteGarrisonStatus')
        .then((response) => {
      ...
      axios.put('http://31.172.83.7:3000/statustrueStaff')
        .then((response) => {
      ...
      axios.put('http://31.172.83.7:3000/statustrueVehcle')
        .then((response) => {
          // console.log(dispatch, response.data)
        })
        .catch((error) => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await axios.post('http://31.172.83.7:3000/newGarisson', postData);
      ...
      const updateVehicleResponse = await axios.put(`http://31.172.83.7:3000/updateVehicle/${vechicleId}`);
      console.log(updateVehicleResponse);
      console.log("update vehicle api working");

      const updateStaffResponse = await axios.put('http://31.172.83.7:3000/updateStaff', { dataArray: staffIds });
      console.log(updateStaffResponse);
      console.log("update staff api working");

      // Fetch updated garisson data
      // const garissonResponse = await axios.get('http://31.172.83.7:3000/newGarissonData');
      // setGarison(garissonResponse.data);
      // console.log("New garission data api working");

      // Fetch updated vehicle and staff status
      const vehicleResponse = await axios.get('http://31.172.83.7:3000/getVehcleStatus');
      setVehicle(vehicleResponse.data);
      console.log("getVehicle stats api working");

      const staffResponse = await axios.get('http://31.172.83.7:3000/getStaffStatus');
      setStaff(staffResponse.data);
      console.log("getstaff stats api working");

      // Fetch updated garisson data again
      const updatedGarissonResponse = await axios.get('http://31.172.83.7:3000/newGarissonData');
