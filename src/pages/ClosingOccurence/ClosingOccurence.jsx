...
const ClosingOccurence = () => {
  ...
  const handleFieldChange = (id, key, value) => {
    ...
    if (key === "phone") {
      ...
      axios.get(`http://31.172.83.7:3000/getoccurencebyphonenumber/${value}`)
        .then((res) => {
  ...
  useEffect(() => {
    axios.get("http://31.172.83.7:3000/getSaveOccurence")
      .then((res) => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get("http://31.172.83.7:3000/getnewoccuranceAllStatusWithZeroAndTwo")
      .then((response) => {
    ...
    axios
      .get("http://31.172.83.7:3000/getGarrisonAll")
      .then((response) => {
    ...
    axios.get('http://31.172.83.7:3000/newGarissonData')
      .then((response) => {
    ...
    axios.get("http://31.172.83.7:3000/getApplicants").then((response) => {
      setApplicants(response.data);
      console.log(response.data);
    });

    axios.get("http://31.172.83.7:3000/getStreet").then((response) => {
  ...
  const handleDeleteClick = (e) => {
    ...
    axios.post("http://31.172.83.7:3000/createreport", { IdOfOccurence, formFields, description })
      .then((response) => {
    ...
    axios
      .put(`http://31.172.83.7:3000/updataGarrisonToTrue/${id}`)
      .then((response) => {
        console.log(response);
      })
      .catch((error) => {
    ...
    axios.put(`http://31.172.83.7:3000/occuranceclosed/${id}`, { ClosedBy })
      .then((response) => {
    ...
    axios
      .put(`http://31.172.83.7:3000/updataGarrisonStat`, {})
      .then((response) => {
        console.log(response);
      })
      .catch((error) => {
  ...
  const handleCloseAndDelete = () => {
    axios.delete(`http://31.172.83.7:3000/saveOccurenceDelete/${idForSaving}`)
      .then((res) => {
  ...
  const showReport = (id) => {
    ...
    axios.get(`http://31.172.83.7:3000/view-pdf/new/${id}?ReportCreatedBy=${ReportCreatedBy}`, { responseType: 'text' })
      .then((response) => {
  ...
  const handleClose = (event, reason) => {
    ...
    if (reason !== 'backdropClick' && reason !== 'escapeKeyDown') {
      ...
      axios.put(`http://31.172.83.7:3000/saveOccurence/${idForSaving}`, { formFields, description })
        .then((res) => {
          console.log(res)
          setOpen(false);
          // setSelectedValue(""); // Reset selectedValue on dialog close
  ...
  const onActive = (id) => {
    ...
    axios.put(`http://31.172.83.7:3000/newGarisonActive/${id}`).then((response) => console.log(response))

    axios.get('http://31.172.83.7:3000/newGarissonData').then((response) => {
      setGarison(response.data);
    })
  ...
  const onInActive = (id) => {
    ...
    axios.put(`http://31.172.83.7:3000/newGarisonInActive/${id}`).then((response) => console.log(response))
    axios.get('http://31.172.83.7:3000/newGarissonData').then((response) => {
      setGarison(response.data);
    })
