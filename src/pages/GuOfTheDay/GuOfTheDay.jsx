...
const GuOfTheDay = () => {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    axios
      .get("http://31.172.83.7:3000/getnewoccuranceAllStatus")
      .then((response) => {
  ...
  const handleData = (e) => {
    ...
    axios.put(`http://31.172.83.7:3000/occuranceDispatch/${occuranceId}`, { DispatchBy })
      .then((response) => {
        console.log("data is ", response);
        axios.get("http://31.172.83.7:3000/getnewoccuranceAllStatus")
          .then((response) => {
            SetOccurance_hold(response.data);
          })
          .catch((error) => {
    ...
    // dispatch time added 
    axios.put(`http://31.172.83.7:3000/occuranceDispatchTime/${occuranceId}`)
      .then((response) => {
    ...
    axios.put(`http://31.172.83.7:3000/updataGarrison`, { dataArray: bunchId })
      .then((response) => {
        console.log(response);
        // Fetch updated GarisonFalse data after dispatch
        axios.get("http://31.172.83.7:3000/getGarrison")
          .then((response) => {
            setGarisonFalse(response.data);
    ...
    axios.put(`http://31.172.83.7:3000/occuranceDispatchGarison/${occuranceId}`, { dataArray: av_garison })
      .then((response) => {
        console.log(response);
      })
      .catch((error) => {
