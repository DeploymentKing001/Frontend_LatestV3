...
const ViewItems = () => {
  ...
  useEffect(() => {
    axios.get("http://31.172.83.7:3000/admin/dashboard/viewitems/getRegisteredUser")
      .then((res) => {
  ...
  const handleSave = () => {
    axios.put(`http://31.172.83.7:3000/updateOccurence/${selectedUser._id}`, { username, password, designation })
      .then((res) => {
        console.log(res);
  ...
  const handleConfirmDelete = () => {
    ...
    axios.delete(`http://31.172.83.7:3000/deleteoccurrence/${selectedUser._id}`)
      .then((res) => {
