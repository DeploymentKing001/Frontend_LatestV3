...
const Report = () => {
    ...
    useEffect(() => {
        setLoading(true);
        axios.get("http://31.172.83.7:3000/occurencewithstatusthree")
            .then((res) => {
                setResult(res.data);
    ...
    const previewPdf = async (id) => {
        ...
        axios.get(`http://31.172.83.7:3000/create-pdf/new/${id}?ReportCreatedBy=${ReportCreatedBy}`, { responseType: 'text' })
            .then((response) => {
    ...
    const takeToPdfPage = async (id) => {
        ...
        try {
            const response = await axios.get(`http://31.172.83.7:3000/u/download-pdf/${id}`, {
                params: {
            ...
            axios({
                url: `http://31.172.83.7:3000/pdf/${id}`,
                method: 'GET',
    ...
    const createAndDownloadPdf = (id) => {
        ...
        axios.post(`http://31.172.83.7:3000/create-pdf/${id}`, { ReportCreatedBy })
            .then((response) => {
